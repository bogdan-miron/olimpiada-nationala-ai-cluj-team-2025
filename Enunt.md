...
### Rezultatul Așteptat
- **P1 (40p): Un fisier CSV cu statistici numit `dataset_stats.csv`**, care sa contina coloanele:
   - `avg_traffic_level`(20p) - reprezentand media nivelelor de trafic din setul de date pentru predictie
